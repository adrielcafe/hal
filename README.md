...
[![Bitrise](https://img.shields.io/bitrise/29bfee3f365ee4b9/master.svg?style=for-the-badge&token=-KZNny2tfEouRiyRtPQW7A)](https://app.bitrise.io/app/29bfee3f365ee4b9) 
...
```gradle
dependencies {
    // Core with Coroutine state observers
